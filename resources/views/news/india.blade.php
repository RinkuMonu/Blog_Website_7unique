...
<body>
    ...
    <div class="container my-4">
        ...
        <div class="row mt-5 pt-4 border-top">
            ...
            <div class="col-lg-4">
                ...
                <!-- Story 1 -->
                <a href="#" class="d-flex align-items-start mb-4 pb-4 border-bottom txt">

    <img src="{{ asset('img/modi.png') }}" 
         width="110" 
         height="85" 
         class="me-3" 
         alt="News image">
    ...
    <div>
        ...
        <p class="small mb-0 text-muted">PTI</p>
    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="mt-5">
                    ...
                    <div class="latest-news">
                        ...
                        <!-- Item 1 -->
                        <a href="#" class="timeline-item active txt">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <a href="#" class="mb-0 txt">
                                    Rahul Gandhi uninterested in Parliament; ‘tutored by NGOs’ on revival of
                                    Congress
</a>
                            </div>
                        </div>
