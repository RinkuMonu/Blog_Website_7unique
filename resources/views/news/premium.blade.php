    ...
    <div class="container my-5">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <div class="mx-4 d-flex align-items-center">
                ...
                <img src="{{ asset('img/th-yellow.svg') }}" alt="TH" style="width:45px;height:45px;border-radius:50%;">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 border-start ps-4">
                ...
                <a href="#" class="smll fw-bold" style="font-size:10px;">
            ...
            <div class="container my-5">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-md-7">
                        ...
                        <!-- Section Title -->
                        <h3 class="red fw-bold mb-4 text-center" style="font-family:'Playfair Display', serif;">
                        ...
                        <div class="d-flex align-items-start py-4 border-bottom">
                            ...
                            <div class="me-3" style="width:90px;">
                                <a href="#" class="txt">
                                    <img src="{{ asset('img/premium1.png') }}" class="img-fluid">
                                </a>
                            </div>
                        ...
                        <div class="d-flex align-items-start py-4 border-bottom">
                            ...
                            <div class="me-3" style="width:90px;">
                                <a href="#" class="txt">
                                    <img src="{{ asset('img/premium2.png') }}" class="img-fluid">
                                </a>
                            </div>
                        ...
                        <div class="d-flex align-items-start py-4 border-bottom">
                            ...
                            <div class="me-3" style="width:90px;">
                                <a href="#" class="txt">
                                    <img src="{{ asset('img/premium3.png') }}" class="img-fluid">
                                </a>
                            </div>
                        ...
                        <div class="d-flex align-items-start py-4 border-bottom">
                            ...
                            <div class="me-3" style="width:90px;">
                                <a href="#" class="txt">
                                    <img src="{{ asset('img/premium4.png') }}" class="img-fluid">
                                </a>
                            </div>
                        ...
                        <div class="d-flex align-items-start py-4 border-bottom">
                            ...
                            <div class="me-3" style="width:90px;">
                                <a href="#" class="txt">
                                    <img src="{{ asset('img/premium5.png') }}" class="img-fluid">
                                </a>
                            </div>
